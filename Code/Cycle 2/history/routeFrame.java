...
public class routeFrame extends javax.swing.JFrame {
    ...
    public routeFrame(Director d,JTextArea history) {// added
        this.d = d;
        initComponents();
	...
	routeNumberText.setText(Integer.toString(d.getAllRoutes().getLast().getNumber()+1));
        ...
        acceptButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	acceptRouteOptionActionPerformed(evt);
            }
        });//change
    ...
    private void acceptRouteOptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteRouteOptionActionPerformed
		//new DeleteRoute(d);
		history.append("A new route has been added to the system.\n");
	}//added
